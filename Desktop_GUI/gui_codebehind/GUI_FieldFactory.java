...
public final class GUI_FieldFactory {
    ...
    public static GUI_Field[] makeFieldsJuniorMatador() {
        ...
        fields[i++] = new GUI_Street("GATEKJØKKENET \n BURGERBAREN", "M1", "GATEKJØKKENET", "Leje:  1", new Color(90, 40, 0), Color.BLACK);
        fields[i++] = new GUI_Street("Pizzahuset \n Pizzeriaet", "M1", "Pizzahuset", "Leje:  1", new Color(90, 40, 0), Color.BLACK);
        fields[i++] = new GUI_Chance("?", "Try your luck", "Take a chancecard", new Color(204, 204, 204), Color.BLACK);
        fields[i++] = new GUI_Street("Godtebutikken \n Slikbutikken", "M1", "Slikbutikken", "Leje:  1", new Color(75, 155, 225), Color.BLACK);
        fields[i++] = new GUI_Street("ISKIOSKEN \n ISKIOSKEN", "M1", "ISKIOSKEN", "Leje:  1", new Color(75, 155, 225), Color.BLACK);
        fields[i++] = new GUI_Jail("default", "Prison", "Prison", "Visting Prison", new Color(125, 125, 125), Color.BLACK);
        fields[i++] = new GUI_Street("Museet \n Museet", "M2", "Museet", "Leje:  1", new Color(200, 100, 225), Color.BLACK);
        fields[i++] = new GUI_Street("Bibloteket \n Bibloteket", "M2", "Bibloteket", "Leje:  1", new Color(200, 100, 225), Color.BLACK);
        fields[i++] = new GUI_Chance("?", "Try your luck", "Take a chancecard", new Color(204, 204, 204), Color.BLACK);
        fields[i++] = new GUI_Street("Rullebretparken \n Skateparken", "M2", "Rullebretparken", "Leje:  1", new Color(250, 150, 0), Color.BLACK);
        fields[i++] = new GUI_Street("Svømmebassenget \n Swimmingpoolen", "M2", "Svømmebassenget", "Leje:  1", new Color(250, 150, 0), Color.BLACK);
        fields[i++] = new GUI_Refuge("default", "Parkering", "Parkering", "Take a break", Color.WHITE, Color.BLACK);
        fields[i++] = new GUI_Street("Spillehallen \n Spillehallen", "M3", "Spillehallen", "Leje:  1", new Color(250, 1, 0), Color.BLACK);
        fields[i++] = new GUI_Street("Kinoen \n Biografen", "M3", "Kinoen", "Leje:  1", new Color(250, 1, 0), Color.BLACK);
        fields[i++] = new GUI_Chance("?", "Try your luck", "Take a chancecard", new Color(204, 204, 204), Color.BLACK);
        fields[i++] = new GUI_Street("Leketøjsbutikken \n Legetøjsbutikken", "M3", "Legetøjsbutikken", "Leje:  1", new Color(250, 250, 0), Color.BLACK);
        fields[i++] = new GUI_Street("Dyrebutikken \n Dyerhandlen", "M3", "Dyrehandlen", "Leje:  1", new Color(250, 250, 0), Color.BLACK);
        ...
        fields[i++] = new GUI_Street("Bowlinghallen \n Bowlinghallen", "M4", "Bowlinghallen", "Leje:  1", new Color(30, 100, 0), Color.BLACK);
        fields[i++] = new GUI_Street("Zoologisk have \n Zoo", "M4", "Zoo", "Leje:  1", new Color(30, 100, 0), Color.BLACK);
        fields[i++] = new GUI_Chance("?", "Try your luck", "Take a chancecard", new Color(204, 204, 204), Color.BLACK);
        fields[i++] = new GUI_Street("Vannlandet  \n Vandlandet", "M5", "Vandlandet", "Leje:  1", new Color(10, 1, 225), Color.BLACK);
        fields[i++] = new GUI_Street("Strandpromenaden  \n Strandpromenaden", "M5", "Strandpromenaden", "Leje:  1", new Color(10, 1, 225), Color.BLACK);
return fields;
    }
}
