...
public class ChanceCardDeck {
    ...
    public ChanceCardDeck() {
        ...
        Deck[1] = new ChanceCards("Move to START and receive 2$", "CHANCE", 2);
        ...
        Deck[5] = new ChanceCards("Give this card to the ship, and take another one. SHIP: on your next turn you have to sail to any unowned square and buy it. If all of the squares are owned you have to buy one from another player", "CHANCE", 6);
        Deck[6] = new ChanceCards("You ate too much candy, pay 2$ to the bank", "CHANCE", 7);
        Deck[7] = new ChanceCards("Move to an orange or green square. If no one owns it you get it for free, else you have to pay rent to the owner", "CHANCE", 8);
        ...
        Deck[14] = new ChanceCards("Move to a pink or darkblue square, if no one owns the square you get it for free! Otherwise you have to pay rent to the owner", "CHANCE", 15);
        Deck[15] = new ChanceCards("You have made all of your homework, receive 2$ from the bank", "CHANCE", 16);
        Deck[16] = new ChanceCards("Move to a red square, if no one owns it you get it for free! Otherwise you have to pay rent to the owner", "CHANCE", 17);
        Deck[17] = new ChanceCards("Move to the skate park to do the perfect grind! If no one owns it you get it for free, otherwise pay rent to the owner", "CHANCE", 18);
        Deck[18] = new ChanceCards("Move to a lightblue or red square, if no one owns it you get it for free, otherwise pay rent to the owner", "CHANCE", 19);
        Deck[19] = new ChanceCards("Move to a brown or yellow square, if no one owns it you get it for free, otherwise pay rent to the", "CHANCE", 20);
